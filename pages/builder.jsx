...
export default function Builder(props) {
  ...
  return (
    <>
      ...
      >
        <Meta
          title="Resume Builder by Amaan | Get hired with an ATS-optimized resume"
        ...
        <div className="f-col gap-4 md:flex-row justify-evenly max-w-7xl md:mx-auto md:h-screen">
          {!formClose && (
            <form className="p-4 bg-pink-400 exclude-print md:max-w-[40%] md:h-screen md:overflow-y-scroll">
              <LoadUnload/>
              <PersonalInformation />
              <SocialMedia />
              <Summary />
